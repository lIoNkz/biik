...
<style>
    ...
    <section class="content-header">
        ...
        <form action="{{ route('upload') }}" method="post" enctype="multipart/form-data">
            ...
            <br />
            <select name="alt">
                <option value="mainSlider">Главный слайдер</option>
                <option value="youGet1">Красивые интерьеры</option>
                <option value="youGet2">Парковка и покупки</option>
                <option value="youGet3">Спорт-озд места</option>
                <option value="gallery">Галерея</option>
                <option value="gallery">Без категории</option>
            </select>
            <br /> 
